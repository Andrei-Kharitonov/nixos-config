...
-- resize windows
vim.keymap.set('n', '<A-h>', ":lua require('smart-splits').resize_left()<CR>", { silent = true, noremap = true, desc = "Resize window left" })
vim.keymap.set('n', '<A-j>', ":lua require('smart-splits').resize_down()<CR>", { silent = true, noremap = true, desc = "Resize window down" })
vim.keymap.set('n', '<A-k>', ":lua require('smart-splits').resize_up()<CR>", { silent = true, noremap = true, desc = "Resize window up" })
vim.keymap.set('n', '<A-l>', ":lua require('smart-splits').resize_right()<CR>", { silent = true, noremap = true, desc = "Resize window right" })
